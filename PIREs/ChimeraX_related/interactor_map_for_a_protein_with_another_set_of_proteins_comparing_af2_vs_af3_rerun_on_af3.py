...
os.makedirs('/Users/antonyjose/Desktop/JoseLab/Computing/ChimeraX/analyses/figures/pire_interactor_maps_af2_vs_af3_af3_runs', exist_ok=True)
os.makedirs('/Users/antonyjose/Desktop/JoseLab/Computing/ChimeraX/analyses/tables', exist_ok=True)
os.makedirs('/Users/antonyjose/Desktop/JoseLab/Computing/ChimeraX/analyses/tables/pire_interaction_residue_identities_af2_vs_af3_af3_runs', exist_ok=True)
...
all_reg=['RDE-4','ADR-2','ERI-1','RDE-1','ERGO-1','PRG-1','ALG-2','CSR-1','HRDE-1','NRDE-3','HRDE-2','PGL-1','DEPS-1','MUT-16','PID-2','MUT-7','RDE-3','RDE-8','RDE-10','SET-25']
...
path_to_chimerax_interaction_details='/Users/antonyjose/Desktop/JoseLab/Computing/ChimeraX/analyses/reformatted_results/2024_5_18_chimerax_interaction_details_af2_vs_af3/'
...
with open(path_to_fasta_lists+'2024_5_4_A_list_finished_for_af2_vs_af3') as A_list:
    for line in A_list:
        if line.startswith('>'):
            A_name=line
            ...
            for reg in all_reg:
                ...
                file1=open(path_to_tables_output +'/'+ str(A_name_only) + '_interacting_residues.tsv','a')
            ...
            path_to_final_figure=path_to_figures_output + '/pire_interaction_residue_numbers_' + str(A_name_only)+'.svg'
            ...
            path_to_final_figure=path_to_figures_output + '/pire_interactor_maps_' + str(A_name_only)+'.svg'
            plt.savefig(path_to_final_figure, dpi=300, format='svg')
    file1.close()
